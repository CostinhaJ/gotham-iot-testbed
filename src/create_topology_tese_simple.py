...
neigh_clus_domotic_plain = create_cluster_of_nodes(server, project, 2, coords_west_zone[1].x - project.grid_unit * 5, coords_west_zone[1].y + project.grid_unit * 2, 5,
...
neigh_clus_ipcam = create_cluster_of_nodes(server, project, 1, coords_west_zone[1].x + project.grid_unit * 5, coords_west_zone[1].y + project.grid_unit * 2, 2,
...
museum_clus_building_plain = create_cluster_of_nodes(server, project, 2, coords_west_zone[0].x - project.grid_unit * 5, coords_west_zone[0].y + project.grid_unit * 2, 5,
...
museum_clus_ipcam = create_cluster_of_nodes(server, project, 1, coords_west_zone[0].x + project.grid_unit * 5, coords_west_zone[0].y + project.grid_unit * 2, 2,
...
museum_clus_ipconsum = create_cluster_of_nodes(server, project, 1, coords_west_zone[0].x + project.grid_unit * 5, coords_west_zone[0].y + project.grid_unit * 7, 2,
