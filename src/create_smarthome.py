...
sensor_tls = create_node(server, project, coords_west_zone[0].x - project.grid_unit * 1, coords_west_zone[0].y + project.grid_unit * 4, sensor_tls_template_id)
create_link(server, project, szone["node_id"], 3, sensor_tls["node_id"], 0)
set_node_network_interfaces(server, project, sensor_tls["node_id"], "eth0",  ipaddress.IPv4Interface("192.168.17.11/24"), "192.168.17.1", lab_nameserver)
